...
public class PathToLeafFromRootInRange {
  ...
  public static void pathToLeafFromRoot(Node node, String asf, int sum, int lo, int hi){
    ...
    if(node.left!=null)
        pathToLeafFromRoot(node.left,asf+node.data+" ",sum+node.data,lo,hi);
        
    if(node.right!=null)
        pathToLeafFromRoot(node.right,asf+node.data+" ",sum+node.data,lo,hi);
